...
else
{
    ...
    header('location:'.SITEURL.'admin/manage-food.php');
        ...
        <tr>
                        <td>Description:</td>
                        <td>
                            <textarea name="description"  id="" cols="20" rows="5" placeholder="Description for the food" value="<?php echo $description;?>"></textarea>
                        </td>
                    </tr>
        <tr>
            <td>Price : </td>
...
if($current_image != "")
{
    ...
    echo "<div class='error'>Image Not Added</div>";
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(isset($_FILES['image']['name']))
            {
                ...
                if($image_name !="")
                {
                    ...
                    //A. upload the new image
                        ...
                        //rename the image 
                        $image_name="Food_food_".rand(000,999).'.'.$ext;//eg.food_category_834.jpg
            ...
            title='$title',description='$description',price='$price',image_name='$image_name',featured='$featured',active='$active' where id=$id";
